...
const resolveEdoStepNotationsToPatternedIntermediateForms = ( // TODO: this isn't really "resolving" anything anymore, it's more like hydrating, or converting. but now there's that "convert" file in here
    ...
    //
    // still need to:
    // - solve barline at front of stave lines issue
    // - solve barlines aligning from stave to stave (see 72 EVO)
    // - more left-buffering after barline  
