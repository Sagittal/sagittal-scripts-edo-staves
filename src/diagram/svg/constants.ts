...
// const A_LITTLE_EXTRA_ROOM_FOR_SHARP_SIZE: Px = 15 as Px TODO: remove this from everywhere if Dave agrees this is the way to go
const EXTRA_ROOM_FOR_FIFTH_SIZE = 35 as Px
