import { computeRange, Count, EdoStep, Index, max, Max } from "@sagittal/general"
import { Folding } from "../types"

const alignParametersByColumn = <T>(diagramStepParameters: T[], folding: Folding): T[][] => {
    ...
    return folding.map((stepCountByStave: Count<EdoStep>): T[] => {
        ...
        furthestStepAligned = (furthestStepAligned + stepCountByStave) as Index<EdoStep>
