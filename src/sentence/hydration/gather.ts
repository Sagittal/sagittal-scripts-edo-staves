...
import { Flavor, Nominal, Sagittal, SubsetFactor } from "@sagittal/system"
import { Note, Stave } from "../types"
import { EdoStepNotationIndices } from "../chaining"
import { NoteCountsByStave, HydrationState, EdoStepNotationCodewords } from "./types"
...
const gatherEdoStepNotationParameters = (
    ...
    const {
        ...
        extractEdoStepNotationParameters(
            ...
            { step: hydrationState.step, sagittals, flavor, subsetFactor }
        )
    ...
    if (
        ...
        hydrationState.noteInStaveIndex === noteCountsByStave[hydrationState.staveIndex] as Decimal<{ integer: true }> as Index<Note>
    ) {
