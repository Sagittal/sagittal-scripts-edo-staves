...
const DOUBLE_SHARP_OR_FLAT_ABSOLUTE_WHORL_INDEX: Index<Whorl> = 2 as Index<Whorl>
...
const chooseSpelling = (chosenSpelling: Spelling, candidateSpelling: Spelling): Spelling =>
    getAbsoluteWhorlIndex(candidateSpelling.linkIndex) < getAbsoluteWhorlIndex(chosenSpelling.linkIndex) &&
