...
const computeBarClause = (
    { sagittalCodewords, whorlCodewords, assemblyState, startingNewStave }: {
    ...
    !startingNewStave && sagittalCodewords.length === 0 && whorlCodewords.length === 0 && assemblyState.noteCount !== 0 ?
