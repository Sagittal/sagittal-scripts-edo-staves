...
const computeDefiniendum = (
    ...
    `${isFirstExpression ? "" : "5; "}${sagitype};` as Code & Sentence

const computeDefiniens = (
    definiensBody: Io,
    { isFinalExpression }: { isFinalExpression: boolean },
): Io => `${definiensBody}${isFinalExpression ? "" : ","}` as Io
